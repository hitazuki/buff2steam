...
import tempfile
from steam_skin_ops.profit.calculator import TradeSummary
from steam_skin_ops.profit.matching import MatchedTrade, UnmatchedBuy
...
class TestReportGenerator(unittest.TestCase):
    ...
    def test_view_csv(self):
        ...
        import sys
        from steam_skin_ops.profit.reporting.report import console
